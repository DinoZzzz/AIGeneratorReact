                                            ...
                                            {isConflictErrorMessage(operation.error) && (
                                                <>
                                                    ...
                                                    <button
                                                        ...
                                                        className="px-2 py-1 text-[11px] rounded bg-primary hover:bg-primary/90 text-primary-foreground"
                                                    >
                                                        {ot('useServerVersion')}
                                                    </button>
                                                </>
                                                ...
                                                <div className="mt-2 flex gap-2">
                                                    ...
                                                    {isConflictErrorMessage(operation.error) && (
                                                        <>
                                                            ...
                                                            <button
                                                                onClick={() => resolveConflictUseServer(operation.id)}
                                                                className="px-2 py-1 text-xs rounded bg-primary hover:bg-primary/90 text-primary-foreground"
                                                            >
                                                                {ot('useServerVersion')}
                                                            </button>
                                                        </>
