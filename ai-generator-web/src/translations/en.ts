...
export const en: Record<string, string> = {
    ...
    'offline.dataTitle': 'Offline data',
    'offline.dataDescription': 'Download all records and files so the app stays fully usable without an internet connection.',
    'offline.lastSynced': 'Last synced from server',
    'offline.never': 'Never',
    'offline.storageUsage': 'Storage used',
    'offline.persistentStorage': 'Storage protection',
    'offline.protected': 'Protected',
    'offline.notProtected': 'Not guaranteed',
    'offline.downloadAll': 'Download all data for offline',
    'offline.downloadConstruction': 'Download for offline',
    'offline.downloadingRecords': 'Syncing records…',
    'offline.downloadingFiles': 'Downloading files',
    'offline.downloadRequiresConnection': 'Connect to the internet to download data.',
    'offline.downloadDone': 'Offline download complete',
    'offline.pendingBadge': 'Waiting to sync',
