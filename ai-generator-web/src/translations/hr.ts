...
export const hr: Record<string, string> = {
    ...
    'offline.dataTitle': 'Izvanmrežni podaci',
    'offline.dataDescription': 'Preuzmite sve zapise i datoteke kako bi aplikacija bila potpuno upotrebljiva bez internetske veze.',
    'offline.lastSynced': 'Zadnja sinkronizacija sa serverom',
    'offline.never': 'Nikada',
    'offline.storageUsage': 'Iskorištena pohrana',
    'offline.persistentStorage': 'Zaštita pohrane',
    'offline.protected': 'Zaštićeno',
    'offline.notProtected': 'Nije zajamčeno',
    'offline.downloadAll': 'Preuzmi sve podatke za izvanmrežni rad',
    'offline.downloadConstruction': 'Preuzmi za izvanmrežni rad',
    'offline.downloadingRecords': 'Sinkronizacija zapisa…',
    'offline.downloadingFiles': 'Preuzimanje datoteka',
    'offline.downloadRequiresConnection': 'Za preuzimanje podataka potrebna je internetska veza.',
    'offline.downloadDone': 'Izvanmrežno preuzimanje dovršeno',
    'offline.pendingBadge': 'Čeka sinkronizaciju',
