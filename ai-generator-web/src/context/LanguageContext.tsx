...
const translations: Record<Language, TranslationDictionary> = {
    hr: {
        ...
        'settings.languageDescription': 'Odaberite jezik suÄelja',
        'language.croatian': 'Hrvatski',
        'language.english': 'Engleski',
        'history.title': 'Povijest',
        'history.certifier': 'Certifikator',
        'history.createdBy': 'Kreirao',
        'history.constructionPart': 'Dio gradiliÅ¡ta',
        'history.formsCount': 'Broj obrazaca',
        'history.creationTime': 'Vrijeme kreiranja',
        'history.open': 'Otvori',
        'history.remove': 'ObriÅ¡i',
        'history.searchPlaceholder': 'TraÅ¾i dio gradiliÅ¡ta...',
        'history.noDataTitle': 'Nema povijesti',
        'history.noDataDesc': 'Izvezeni izvjeÅ¡taji pojavit Ä‡e se ovdje.',
        'history.loading': 'UÄitavanje...',
        ...
        'exportDetails.includedReports': 'UkljuÄeni izvjeÅ¡taji',
        ...
        'dashboard.ready': 'VaÅ¡ generator je spreman.',
        'dashboard.totalCustomers': 'Ukupno kupaca',
        'dashboard.activeSites': 'Aktivna gradiliÅ¡ta',
        'dashboard.totalReports': 'Ukupno izvjeÅ¡taja',
        'dashboard.customersTable': 'NaruÄitelji',
        'dashboard.search': 'Pretraga...',
        'dashboard.addCustomer': 'Dodaj naruÄitelja',
        'dashboard.workOrder': 'Radni nalog',
        'dashboard.customer': 'NaruÄitelj',
        'dashboard.activeOrders': 'Aktivni radni nalozi',
        'dashboard.none': 'Nema',
        'dashboard.showMore': 'PrikaÅ¾i viÅ¡e',
        'dashboard.showLess': 'PrikaÅ¾i manje',
        'dashboard.loading': 'UÄitavanje...',
        'dashboard.noCustomers': 'Nema kupaca',
        'dashboard.topCustomers': 'NaruÄitelji',
        'dashboard.examiners': 'IspitivaÄi',
        'dashboard.today': 'Danas',
        'dashboard.thisWeek': 'Ovaj tjedan',
        'common.yes': 'Da',
        'common.no': 'Ne',
        'examiners.title': 'IspitivaÄi',
        'examiners.subtitle': 'Upravljajte ispitivaÄima i njihovim akreditacijama.',
        'examiners.add': 'Dodaj ispitivaÄa',
        'examiners.search': 'PretraÅ¾i ispitivaÄe...',
        'examiners.fullName': 'Puno ime',
        'examiners.username': 'KorisniÄko ime',
        'examiners.email': 'Email',
        'examiners.accreditations': 'Akreditacije',
        'examiners.actions': 'Akcije',
        'examiners.loading': 'UÄitavanje...',
        'examiners.noneFound': 'Nema pronaÄ‘enih ispitivaÄa',
        'examiners.noneDesc': 'Dodajte ispitivaÄe kako biste upravljali njihovim akreditacijama i zadacima.',
        'examiners.accessDenied': 'Pristup odbijen',
        'examiners.accessDesc': 'Samo administratori mogu upravljati ispitivaÄima.',
        'examiners.admin': 'Administrator',
        'examiners.removeConfirm': 'Jeste li sigurni da Å¾elite ukloniti ovog ispitivaÄa?',
        'examiners.dialog.new': 'Novi ispitivaÄ',
        'examiners.dialog.edit': 'Uredi ispitivaÄa',
        'examiners.dialog.firstName': 'Ime',
        'examiners.dialog.lastName': 'Prezime',
        'examiners.dialog.username': 'KorisniÄko ime',
        'examiners.dialog.title': 'Titula',
        'examiners.dialog.email': 'Email',
        'examiners.dialog.password': 'Lozinka',
        'examiners.dialog.passwordHint': '(ostavite prazno za zadrÅ¾avanje postojeÄ‡e)',
        ...
        'customers.search': 'PretraÅ¾i kupce...',
        ...
        'customers.loading': 'UÄitavanje...',
        'customers.none': 'Nema pronaÄ‘enih kupaca.',
        'customers.showing': 'Prikazujem',
        'customers.to': 'do',
        'customers.of': 'od',
        'customers.results': 'rezultata',
        'customers.prev': 'Prethodna',
        'customers.next': 'SljedeÄ‡a',
        'customers.viewConstructions': 'Pogledaj gradiliÅ¡ta',
        'customers.edit': 'Uredi',
        'customers.deleteConfirm': 'Brisanje kupca Ä‡e ukloniti sve povezane izvjeÅ¡taje. Nastaviti?'
    },
    en: {
...
Object.assign(translations.hr, {
    'customers.postalCode': 'PoÅ¡tanski broj',
    'customers.save': 'Spremi',
    'customers.loadingForm': 'UÄitavanje...',
    ...
    'customers.placeholderPostal': 'PoÅ¡tanski broj',
    'customers.deleteConfirm': 'Brisanje kupca Ä‡e ukloniti sve povezane izvjeÅ¡taje. Nastaviti?',
    'customers.search': 'PretraÅ¾i kupce...',
    'customers.viewConstructions': 'Pogledaj gradiliÅ¡ta',
    'customers.next': 'SljedeÄ‡a',
    'constructions.title': 'GradiliÅ¡ta',
    'constructions.for': 'za',
    'constructions.new': 'Novo gradiliÅ¡te',
    'constructions.search': 'PretraÅ¾i gradiliÅ¡ta...',
    'constructions.workOrder': 'Radni nalog',
    'constructions.name': 'Naziv',
    'constructions.location': 'Lokacija',
    'constructions.actions': 'Akcije',
    'constructions.viewReports': 'Pogledaj izvjeÅ¡taje',
    'constructions.edit': 'Uredi',
    'constructions.delete': 'ObriÅ¡i',
    'constructions.deleteConfirm': 'Jeste li sigurni da Å¾elite obrisati ovo gradiliÅ¡te? Ovo Ä‡e obrisati sve povezane izvjeÅ¡taje.',
    'constructions.none': 'Nema gradiliÅ¡ta.'
});
...
Object.assign(translations.hr, {
    ...
    'constructions.deleteConfirm': 'Jeste li sigurni da Å¾elite obrisati ovo gradiliÅ¡te? Ovo Ä‡e obrisati sve povezane izvjeÅ¡taje.',
    'constructions.none': 'Nema gradiliÅ¡ta.',
    'constructions.loading': 'UÄitavanje...',
    'constructions.save': 'Spremi',
    'constructions.newTitle': 'Novo gradiliÅ¡te',
    'constructions.editTitle': 'Uredi gradiliÅ¡te',
    'constructions.placeholderWork': 'npr. 2023-001-A',
    'constructions.placeholderName': 'Naziv gradiliÅ¡ta',
    'constructions.placeholderLocation': 'Lokacija gradiliÅ¡ta',
    'reports.title': 'IzvjeÅ¡Ä‡a',
    'reports.deleteSelected': 'ObriÅ¡i odabrano',
    'reports.newReport': 'Novi zapis',
    'reports.generateReports': 'Generiraj izvjeÅ¡Ä‡a',
    ...
    'reports.edit': 'Uredi',
    'reports.delete': 'ObriÅ¡i',
    'reports.noData': 'Nema izvjeÅ¡Ä‡a za ovo gradiliÅ¡te.',
...
Object.assign(translations.hr, {
    ...
    'materials.noneDesc': 'Dodajte materijale kako biste ih koristili u izvjeÅ¡tajima.',
    'materials.edit': 'Uredi',
    'materials.remove': 'Ukloni',
    'materials.added': 'Materijal dodan.',
    'materials.updated': 'Materijal aÅ¾uriran.',
    'materials.removed': 'Materijal uklonjen.',
    'materials.deleteConfirm': 'Jeste li sigurni da Å¾elite ukloniti ovaj materijal?',
    'materials.restricted': 'Upravljanje materijalima je ograniÄeno na administratore.',
    'materials.inUseError': 'Materijal se koristi u izvjeÅ¡tajima pa ga nije moguÄ‡e ukloniti.'
});
...
Object.assign(translations.hr, {
    ...
    'settings.theme': 'Tema',
    'settings.themeDesc': 'Odaberite naÄin prikaza',
...
Object.assign(translations.hr, {
    ...
    'analytics.avgDuration': 'ProsjeÄno trajanje ispitivanja',
    'analytics.water': 'Voda',
    'analytics.air': 'Zrak',
    'analytics.loading': 'UÄitavanje analitike...',
    'analytics.error': 'Neuspjelo uÄitavanje analitike. PokuÅ¡ajte ponovo.'
});
...
Object.assign(translations.hr, {
    ...
    'reports.form.allowedLoss': 'DopuÅ¡teni gubitak',
